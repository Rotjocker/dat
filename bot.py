...
bot_token = "6092308695:AAENbzsnLZUya5wuocpeFB2atCQBOwi_b8E"
...
def check_if_user_in_channel(user_id: str):
    ...
    x = get(
        ...
        + "6092308695:AAENbzsnLZUya5wuocpeFB2atCQBOwi_b8E"
        + "/getchatmember?chat_id=-1001781731232&user_id="
        + user_id
    )
...
رقم التموينية : {person["FAM_NO"]}
        ...
        @vlod2 بس تدخل بيها تلكى رابط القناة الخاصة بيها ف انضم للقناة الخاصة وهاهيه
        """
